...
if [ $CRITICAL -gt 0 ]; then
    ...
    echo -e "   2. Follow remediation steps in tasks/argocd-upgrade-plan.md"
    ...
    echo -e "   2. Consult tasks/argocd-upgrade-plan.md for details"
    ...
    echo ""
    echo -e "   Next Steps:"
    echo -e "   1. Create backups (see tasks/argocd-upgrade-plan.md)"
